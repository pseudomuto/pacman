...
type ArtifactQuery struct {
	...
	withVersions *ArtifactVersionQuery
...
func (_q *ArtifactQuery) QueryVersions() *ArtifactVersionQuery {
	query := (&ArtifactVersionClient{config: _q.config}).Query()
...
func (_q *ArtifactQuery) WithVersions(opts ...func(*ArtifactVersionQuery)) *ArtifactQuery {
	query := (&ArtifactVersionClient{config: _q.config}).Query()
...
func (_q *ArtifactQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Artifact, error) {
	...
	if query := _q.withVersions; query != nil {
		if err := _q.loadVersions(ctx, query, nodes,
			func(n *Artifact) { n.Edges.Versions = []*ArtifactVersion{} },
			func(n *Artifact, e *ArtifactVersion) { n.Edges.Versions = append(n.Edges.Versions, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *ArtifactQuery) loadVersions(ctx context.Context, query *ArtifactVersionQuery, nodes []*Artifact, init func(*Artifact), assign func(*Artifact, *ArtifactVersion)) error {
	...
	query.withFKs = true
	query.Where(predicate.ArtifactVersion(func(s *sql.Selector) {
