...
// Source: github.com/pseudomuto/pacman/internal/publisher (interfaces: Packager,Persister,Uploader,VCSFetcher)
//
// Generated by this command:
//
//	mockgen -destination=mocks_test.go -package=publisher_test . Packager,Persister,Uploader,VCSFetcher
//
...
import (
	...
	ent "github.com/pseudomuto/pacman/internal/ent"
...
func (m *MockPersister) CreateArtifact(arg0 context.Context, arg1 *ent.Artifact) (*ent.Artifact, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateArtifact", arg0, arg1)
	ret0, _ := ret[0].(*ent.Artifact)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreateArtifact indicates an expected call of CreateArtifact.
func (mr *MockPersisterMockRecorder) CreateArtifact(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateArtifact", reflect.TypeOf((*MockPersister)(nil).CreateArtifact), arg0, arg1)
}
...
func (m *MockUploader) Write(arg0 context.Context, arg1 io.Reader, arg2 string) (string, error) {
	m.ctrl.T.Helper()
